...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_5x6(
        QK_LAYER_LOCK      ,KC_EXLM, KC_AT ,KC_HASH,KC_DLR ,MF5,                  MF6,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_DEL,
    ...
    [_RAISE] = LAYOUT_5x6(
          QK_LAYER_LOCK , KC_F1 , KC_F2 , KC_F3 , KC_F4 , MF5 ,                        MF6  , KC_F7 , KC_F8 , KC_F9 ,KC_F10 ,KC_F11 ,
          _______,_______,_______,_______,_______,KC_LBRC,                        KC_RBRC,_______,KC_NUM,KC_INS ,KC_SCRL,KC_MUTE,
          _______,KC_1,KC_UP  ,KC_DEL, KC_ENT, KC_LPRN,                        KC_RPRN,KC_LEFT,KC_UP,KC_DOWN,KC_RIGHT,KC_VOLU,
